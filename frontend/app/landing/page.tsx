    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 dark:from-black dark:via-black dark:to-primary/10">
      ...
      <div className="relative flex w-full flex-col items-start justify-start overflow-hidden pb-20">
        ...
        <div className="z-10 mt-40 w-full">
          ...
          <h1 className="relative z-10 mx-auto max-w-5xl text-center text-3xl md:text-5xl lg:text-8xl font-extrabold text-neutral-900 dark:text-white leading-tight">
            Unlock Smarter Savings
            <span className="block bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">
              with PiggySavfe
            </span>
          </h1>
          <p className="relative z-10 mx-auto mt-6 max-w-3xl text-center text-lg md:text-xl text-neutral-700 dark:text-neutral-300 leading-relaxed">
      ...
      {/* Key Stats Section */}
      <section className="py-16 px-4 bg-white/50 dark:bg-black/50 backdrop-blur-sm">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-primary/5 to-blue-500/5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl border bg-card/80 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl border bg-card/80 backdrop-blur-sm shadow-lg">
